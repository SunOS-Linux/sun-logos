...
%package httpd
Summary: Sun/OS Linux-related icons and pictures used by httpd
Provides: redhat-logos-httpd = %{version}-%{release}
Provides: system-logos-httpd = %{version}-%{release}
Provides: sunoslinux-logos-httpd = %{version}-%{release}
BuildArch: noarch
...
%package ipa
Summary: Sun/OS Linux-related icons and pictures used by ipa
Provides: redhat-logos-ipa = %{version}-%{release}
Provides: system-logos-ipa = %{version}-%{release}
Provides: sunoslinux-logos-ipa = %{version}-%{release}
BuildArch: noarch

%description ipa
Licensed only for approved usage, see COPYING for details.

%package -n sunoslinux-backgrounds
Summary: Sun/OS Linux-related desktop backgrounds
BuildArch: noarch

Obsoletes: sunoslinux-logos < 80.1-2
Provides:  redhat-backgrounds = %{version}-%{release}
...
- Initial build for Sun/OS Linux 8.3
